...
(function (window, document, Math) {
    ...
    function Scroll(id, params) {
        ...
        //REM基值，根据不同屏幕dpr值动态获取
        this.fontSize = parseInt(document.documentElement.style.fontSize.substr(0,document.documentElement.style.fontSize.length-2));
        ...
        this.scrollHeight = this.childNodeHeight - this.scrollerHeight;//滚动高度：应该是隐藏掉的高度
    ...
    Scroll.prototype = {
        ...
        _move: function () {
            ...
            self.scroller.addEventListener('touchmove', function (e) {
                ...
                var grank = movePageY/self.fontSize;

                self.browserVendor('transform', 'translate(0, '+grank +'rem)');



                console.log(diffPageY)


                // self.browserVendor('transform', 'translate(0, '+ movePageY/self.fontSize +'rem)');
                // console.log(movePageY)
        ...
        _end: function () {
            ...
            self.scroller.addEventListener('touchend', function (e) {
                ...
                if( self.options.step && self.stepLen > 0 ){
                    ...
                    // console.log(self.stepLen)
                    var h = Math.abs( nowEndY % self.stepLen );//滚动多余不足step的高度
                    // console.log(h)
                    var halfHeight = self.stepLen ;//step一半的高度 修改ing
                ...
                self.browserVendor('transform', 'translate(0, '+ self.offsetTop/self.fontSize +'rem)');
            }, false);
        },
        ...
        scrollTo: function (x, y, time) {
            ...
            // console.log(self.fontSize);
            // console.log(y);
            self.browserVendor('transform', 'translate(0, '+ y/self.fontSize +'rem)');
        },
    ...
    DatePicker.prototype = {
        ...
        FillData: function () {
            ...
            for( var i = 0; i < pickerWrapperArr.length; i++ ){
                pickerWrapperArr[i].style.fontSize = parseInt(document.documentElement.dataset.dpr, 10)*16+"px";
            ...
            setTimeout(function () {
                document.querySelector('.zx_select').style.height = '5.5rem';
            }, 0);
        },
        ...
        SetItemList: function (index, nowScroll) {
            ...
            if (nowScroll) {
                // 当前选择项的值
                var nowItem = {};
                // console.log(nowScroll.attributes[0])
